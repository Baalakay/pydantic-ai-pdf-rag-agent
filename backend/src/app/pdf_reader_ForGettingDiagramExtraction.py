...
from backend.src.app.models.comparison import ModelSpecs, ComparisonResult, ElectricalSpecs, MagneticSpecs, PhysicalSpecs, KeyDifferences
from pathlib import Path
from backend.src.app.core.config import get_settings


def find_pdf_by_model(model_keyword: str, pdf_dir: Optional[Path] = None) -> Optional[str]:
    """Find a PDF file by model keyword.
    
    Args:
        model_keyword: The model keyword to search for
        pdf_dir: Optional directory to search in, defaults to settings.PDF_DIR
